...
public class Player implements Movable {
     ...
     * aktuális cellától lekért szomszéd cella elfogadja a játékos lépési
    ...
    /**
     * Doboz felvételének első lépése. Ekkor a játékos orientációjában lévő
     * szomszédos cellának jelzi a játékos a doboz felvevési szándékát.
     */
    public void boxUp() {
        if (box != null) {
    ...
    /**
     * Paraméterül kapott doboz felvétele. Ilyenkor a játékos súlya is megnő a
     * doboz súlyával.
     *
    ...
    /**
     * Doboz ledobása a játékossal szembeni cellára, ha van. Sikeres ledobás
     * esetén játékos súlya lecsökken a doboz súlyával.
     */
    public void boxDown() {
        Cell nCell = actualCell.getNeighbour(dir);
    ...
    /**
     * ZPM felvétele. Ha így páros számú ZPM-je lesz a játékosnak, meghívjuk a
     * MapManager.INSTANCE createZPM metódusát.
     *
     * @param zpm
     */
    @Override
    ...
    /**
     * Dobozzal való játékos esetén megütközik a játékos, azaz nem tud tovább
     * menni.
     *
     * @param box
